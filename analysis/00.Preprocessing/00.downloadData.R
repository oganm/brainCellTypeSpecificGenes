...
getGemmaAnnot('GPL1261','data/GemmaAnnots/GPL1261',annotType='noParents')
getGemmaAnnot('GPL339','data/GemmaAnnots/GPL339',annotType='noParents')
getGemmaAnnot('GPL570','data/GemmaAnnots/GPL570',annotType='noParents')
getGemmaAnnot('GPL96','data/GemmaAnnots/GPL96',annotType='noParents')
getGemmaAnnot('GPL97','data/GemmaAnnots/GPL97',annotType='noParents')
getGemmaAnnot('GPL5175','data/GemmaAnnots/GPL5175',annotType='noParents')
